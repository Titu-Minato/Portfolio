...
const roles = ["Data Scientist", "Machine Learning Enthusiast", "Python Developer", "Data Visualization Expert"];
        ...
        <section className="hero section" id="home">
            <div className="hero__content">
                ...
                <div className="hero__actions">
                    ...
                    <a href={personalInfo.socials.github} className="btn btn-outline" target="_blank" rel="noreferrer">
